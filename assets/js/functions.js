...
t.fn.masonryFilter = function (options) {
    ...
    if (t(window).on("load", function() {
            ...
            }, 400), a.indexOf("left_m") > 0 && setTimeout(function() {
                t(".overlay-bg-d").css({
                    right: "0%",
                    background: "#053c69",
                    opacity:"1"
            ...
            }, 400), a.indexOf("right_m") > 0 && setTimeout(function() {
                t(".overlay-bg-d").css({
                    left: "0%",
                    background: "#053c69",
                    opacity:"1"
            ...
            t(this).html(e.strftime("<div>%D<span>Days</span></div> <div>%H<span>Hours</span></div> <div>%M<span>Minutes</span></div> <div>%S<span>Seconds</span></div>"))
